 ...
 * @Subclass RBTree 
 * @Description: Source from Intro to Java, 9th ed., Bonus Web Chapter #48, by Daniel Liang.
 * Extends BST, overriding constructors, createNewNode(), insert(), and preorder() methods.
 * Includes added boolean getRed method to aid construction of RBTree animation
 */

//Begin Subclass RBTree
public class RBTree<E extends Comparable<E>> extends BST<E> {
  ...
  /** Override createNewNode to create an RBTreeNode
     * @param e element of unspecified type
     * @return a tree node*/
  @Override
  ...
  private void fixDoubleRed(RBTreeNode<E> u, RBTreeNode<E> v, 
    ...
    if (x == null || x.isBlack()) {
      ...
      else if (parentOfw != null && ((RBTreeNode<E>)parentOfw).isRed()) 
      {  
   ...
   * Return false if the element is not in the tree
     * @param e
     * @return boolean deletion's success?*/
  @Override
  ...
  private void fixDoubleBlack(
    ...
    /**
     *Return boolean to indicate color of node
     * @param e
     * @return boolean: true if node is red
     */
    protected boolean getRed(TreeNode<E> e)
  {
      RBTreeNode<E> aNode = (RBTreeNode<E>)e;
      boolean b = true;
      if(aNode.isBlack())
      {
          b = false;
